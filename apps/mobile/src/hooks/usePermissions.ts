 ...
 * plus the raw role. Use this to gate action affordances (FAB create, edit,
 * delete) so read-only roles like `accountant` don't see controls they can't
 * use. The server still enforces every mutation.
 */
