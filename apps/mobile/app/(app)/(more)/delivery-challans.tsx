    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.body}>
        <View style={styles.iconWrapper}>
          <Ionicons name="car-outline" size={56} color="#6366f1" />
        </View>
        <Text style={styles.heading}>Delivery Challans</Text>
        <Text style={styles.subtext}>Track deliveries and generate delivery challans for your shipments.</Text>
