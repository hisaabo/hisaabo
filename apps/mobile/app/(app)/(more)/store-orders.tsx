    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.body}>
        <View style={styles.iconWrapper}>
          <Ionicons name="storefront-outline" size={56} color="#6366f1" />
        </View>
        <Text style={styles.heading}>Store Orders</Text>
        <Text style={styles.subtext}>Manage orders from your online store in one place.</Text>
