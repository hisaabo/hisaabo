...
1. Go to **Cash & Bank** → **Add Account**
2. Select **Payment Gateway** as account type
3. Enter name (e.g., "Razorpay")
...
1. Select the payment mode (Credit Card, Debit Card, UPI, etc.)
