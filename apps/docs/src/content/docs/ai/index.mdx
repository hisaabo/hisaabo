---
title: AI & Automation
description: Connect Hisaabo to AI agents, automate business operations, and leverage intelligent features. MCP server, CLI tool, and upcoming AI capabilities.
sidebar:
  order: 1
---
...
This section covers what is available today and what is coming next.
