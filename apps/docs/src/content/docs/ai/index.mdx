---
title: AI & Automation
description: The only Indian invoicing platform with native AI agent support. ~50 MCP tools covering every business operation. Connect Claude, build automations, and let AI handle your bookkeeping while you run your business.
sidebar:
  order: 1
---
...
- The [MCP server](/ai/mcp-server/) gives AI assistants like Claude structured, typed access without writing API code — ~50 tools covering invoicing, parties, inventory, payments, expenses, GST, shipping, banking, reports, store, targets, and bulk import
- [Browser AI agents (WebMCP)](/ai/webmcp/) get the same treatment without any setup — Gemini in Chrome and Copilot in Edge discover Hisaabo's tools in the tab you already have open, running on your own browser AI subscription
- The [CLI tool](/ai/cli/) is built with Ink 5 (React for the terminal) and lets you pipe business data into shell scripts and automation workflows
...
- [Browser AI Agents (WebMCP)](/ai/webmcp/) — Let Gemini in Chrome or Copilot in Edge use Hisaabo with no setup
